...
[Найдите очные курсы и курсы по запросу, на которых сертифицированные инструкторы Microsoft Certified Trainers обучают технологиям Microsoft.](/learn/certifications/partners)
...
Чтобы получить код, вы можете быть членом нашей базы данных профилей SME или получить его в разделе объявлений в [блоге Microsoft Learn](https://aka.ms/learningblog). Квалифицированные участники программы базы данных профилей SME получают уникальный код скидки для участия в бета-экзаменах, что повышает вероятность получения места на бета-экзамене.

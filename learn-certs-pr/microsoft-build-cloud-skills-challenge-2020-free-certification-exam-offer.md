...
![Введите адрес электронной почты, который вы использовали для регистрации на событие](images/step5-1-enter-email.png)
...
![Свяжите учетные записи, чтобы получить скидку](images/step7-linkmodal.png)
...
![Выберите скидку и продолжите, нажав на кнопку запланированного экзамена](images/step8-coupon.png)

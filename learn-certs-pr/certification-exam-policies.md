...
У корпорации Microsoft есть определенные политики, которые касаются областей безопасности, относящихся к экзаменам Microsoft сертификационный экзамен.
...
1. Общая политика повторной сдачи сертификационного экзамена Microsoft
    1. Если кандидат не получит проходной балл в первый раз, он должен подождать 24-30 часов, прежде чем сдавать экзамен во второй раз. По истечении этого периода времени кандидаты могут войти в свою [панель управления сертификациями](https://aka.ms/certdashboard) и перенести экзамен самостоятельно.
    ...
    **Исключительными случаями, позволяющими повторно сдать экзамен, являются:**
      - Несдача по причине сбоя в лаборатории
      - Несдача из-за проблем с интернет-соединением 
      - Несдача из-за отказа оборудования
      - Запросы, которые включают номер решения Pearson VUE

    **Исключительными случаями, позволяющими повторно сдать экзамен, не являются:**
      - Несдача из-за недостатка подготовки, знаний, навыков или способностей кандидата
      - Запросы, которые не включают номер решения Pearson VUE

    Запросы на повторную сдачу экзамена в исключительных случаях следует направлять по адресу [mlsecure@microsoft.com](mailto:mlsecure@microsoft.com). Запрос должен включать следующую информацию:
      - ID кандидата
      - Имя/Фамилия
      - Эл.почта, связанная с вашим ID кандидата
      - Регистрационный номер экзамена
...
4. Правила повторной сдачи beta-экзаменов

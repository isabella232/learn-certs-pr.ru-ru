...
## Правила безопасности и повторной сдачи
...
5. Исключения из правил повторной сдачи экзаменов
    ...
    2. Microsoft оставляет за собой право предоставлять возможность пересдачи некоторых экзаменов. Для получения полного списка экзаменов, которые можно пересдавать ежегодно, нажмите [здесь](https://www.microsoft.com/ru-ru/learning/exam-certification-retakes.aspx).
...
3. **ПРАВИЛА ПРОВЕДЕНИЯ ЭКЗАМЕНОВ**
    ...
    Вы несете полную ответственность за понимание и соблюдение правил и процедур проведения сертификационных экзаменов Microsoft, находящихся по адресу [https://www.microsoft.com/ru-ru/learning/certification-exam-policies.aspx](https://www.microsoft.com/ru-ru/learning/certification-exam-policies.aspx), а также правил и процедур поставщика услуг по приему экзамена.

    Вы можете ознакомиться с правилами повторной сдачи экзаменов Microsoft, а также с другими процедурами проведения Экзамена и тестирования по адресу [https://www.microsoft.com/ru-ru/learning/certification-exam-policies.aspx](https://www.microsoft.com/ru-ru/learning/certification-exam-policies.aspx). На веб-сайте поставщика услуг по приему Экзамена Экзаменуемые могут больше узнать о его правилах и процедурах.
...
2. СЕРТИФИКАЦИЯ MICROSOFT
   1. *Порядок получения и подтверждения сертификации Microsoft*: Для получения и подтверждения сертификации Microsoft необходимо:
        ...
        1. Сдать все обязательные экзамены и соответствовать всем требованиям сертификации и повторной сертификации для соответствующей [сертификации Microsoft](https://www.microsoft.com/ru-ru/learning/browse-all-certifications.aspx?certificationtype=role-based),
   ...
   2. *Изменения требований программы сертификации Microsoft*: Корпорация Microsoft может по своему усмотрению вносить изменения в требования программы сертификации Microsoft (как в исходные, так и в действующие) в любой момент, опубликовав их на [веб-сайте, посвященном образовательным курсам и сертификациям Microsoft](https://www.microsoft.com/ru-ru/learning/browse-all-certifications.aspx?certificationtype=role-based) или на [веб-сайте, посвященном сертификациям Microsoft](https://www.microsoft.com/ru-ru/learning/browse-all-certifications.aspx?certificationtype=role-based). На выполнение всех дополнительных требований Вам предоставляется три (3) полных календарных месяца от даты публикации изменений корпорацией Microsoft. Ваше право на использование определенных данных о Квалификации может быть прекращено, в случае несоблюдения вами каких-либо дополнительных требований к сертификации или повторной сертификации, связанных с определенными Квалификациями.
...
[AZ-100: Инфраструктура Microsoft Azure и развертывание](https://www.microsoft.com/ru-ru/learning/exam-AZ-100.aspx)

[AZ-101: Интеграция Microsoft Azure и безопасность](https://www.microsoft.com/ru-ru/learning/exam-AZ-101.aspx)

[AZ-103: Администратор Microsoft Azure](https://www.microsoft.com/ru-ru/learning/exam-az-103.aspx)

AZ-200: Основные Решения Для Разработчиков Microsoft Azure

AZ-201: Расширенные решения для разработчиков Microsoft Azure

[AZ-203: Разработка решений для Microsoft Azure](https://www.microsoft.com/ru-ru/learning/exam-AZ-203.aspx)

[AZ-300: Технологии Microsoft Azure Architect](https://www.microsoft.com/ru-ru/learning/exam-AZ-300.aspx)

[AZ-301: Дизайн архитектуры Microsoft Azure](https://www.microsoft.com/ru-ru/learning/exam-AZ-301.aspx)

[AZ-400: Решения Microsoft Azure DevOps](https://www.microsoft.com/ru-ru/learning/exam-AZ-400.aspx)
...
- Шаг 2: Войдите в свою учетную запись в [панели управления сертификацией Microsoft](https://www.microsoft.com/ru-ru/learning/dashboard.aspx)
...
- Дополнительную информацию см.: [Значки экзаменационной сертификации Microsoft](https://www.microsoft.com/ru-ru/learning/badges.aspx)
...
### Правила отмены и изменения графика сдачи:
...
- [Просмотрите все экзамены](https://www.microsoft.com/ru-ru/learning/exam-list.aspx), чтобы найти интересующий Вас.
...
Перейдите на [страницу регистрации на экзамен](https://www.microsoft.com/ru-ru/learning/certification-exams.aspx), чтобы выполнить инструкции.
...
- Для всех остальных экзаменов [просмотрите список всех экзаменов](https://www.microsoft.com/ru-ru/learning/exam-list.aspx), чтобы найти страницу экзамена, которая включает стоимость экзамена.
...
Если у вас имеются какие-либо сомнения, касающиеся технической точности конкретного предмета, пожалуйста, ознакомьтесь с процессом [Возражения против пунктов экзамена](https://www.microsoft.com/ru-ru/learning/certification-exam-policies.aspx#policies-5).
...
Чтобы предложить другие варианты отзыва, обратитесь в свой [Региональный сервисный центр Microsoft](https://www.microsoft.com/ru-ru/learning/help.aspx).
...
Если вы не нашли отчет со своими оценками на сайте и не получили в течение двух недель от даты публикации конечной версии экзамена, обратитесь к поставщику услуг по приему экзаменов за дополнительными сведениями о времени обработки ваших результатов. С вопросами по выписке из зачетной ведомости (транскрипта) обращайтесь в [Региональный сервисный центр Microsoft](https://www.microsoft.com/ru-ru/learning/help.aspx).
...
Поздравляем! Чтобы узнать о дальнейших действиях и доступных преимуществах, воспользуйтесь [преимуществами и панелью управления экзаменами](https://www.microsoft.com/ru-ru/learning/dashboard.aspx). Войдите с помощью той же учетной записи Microsoft, которая использовалась для регистрации на экзамен.
...
Пожалуйста, см. [Политику безопасности и повторной сдачи экзамена](https://www.microsoft.com/ru-ru/learning/certification-exam-policies.aspx#security-policies), для того, чтобы ознакомиться с правилами повторно сдачи экзамена.
...
С общими вопросами по регистрации на экзамен обращайтесь в свой [Региональный сервисный центр Microsoft](https://www.microsoft.com/ru-ru/learning/help.aspx). С вопросами о новых и текущих заявках на проверку можно [обратиться в Поддержку](https://academic.getmicrosoftkey.com/default/support).

...
Корпорация Microsoft обеспечивает наивысшее качество своих экзаменов и сертификаций, которыми пользуются партнеры и клиенты по всему миру. Для поддержки целей программы сертификации были разработаны правила проведения сертификационных экзаменов Microsoft. Ознакомьтесь со следующими статьями о правилах проведения экзаменов и часто задаваемых вопросах:

- [Краткий обзор процедуры экзамена](/learn/certifications/exam-process-overview)
...
- [Бета-экзамены](/learn/certifications/beta-exams)
- [Получение кредитов за сертификационные экзамены](/learn/certifications/college-credit-for-certification-exams)
- [Студенческие скидки](/learn/certifications/student-discounts)
- [Связаться со службой поддержки](/learn/certifications/help)

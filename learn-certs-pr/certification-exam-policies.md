...
---
# Экзаменационная политика и часто задаваемые вопросы
...
1. Присоединиться к нашей базе данных профилей SME. Участники, навыки которых соответствуют содержимому экзамена, получат сообщения электронной почты с кодом; код является уникальным для этой группы. (С марта 2018 г. программа базы данных профилей SME размещена на платформе [Microsoft Collaborate](https://aka.ms/collaborate). См. публикацию в блоге [Помогите нам в создании экзаменов и учебного контента!](https://borntolearn.mslearn.net/b/weblog/posts/help-us-create-exams-and-learning-content-join-our-sme-database-today) Присоединяйтесь к нашей базе данных SME сегодня!)
2. Данные о предстоящих beta-экзаменах публикуются в нашем блоге. В постах будут указываться коды, которые можно будет использовать для получения скидки на экзамены. Как правило, посты публикуются в день открытия регистрации на beta-экзамен. Этот код отличен от того, который рассылается участникам базы данных профилей SME.

Обратите внимание, что количество мест ограничено и доступно по принципу очередности обслуживания.
...
3. **ПРАВИЛА ПРОВЕДЕНИЯ ЭКЗАМЕНОВ**
    ...
    Вы несете полную ответственность за понимание и соблюдение правил и процедур проведения сертификационных экзаменов Microsoft, находящихся по адресу [https://www.microsoft.com/learning/certification-exam-policies.aspx](https://www.microsoft.com/learning/certification-exam-policies.aspx), а также правил и процедур поставщика услуг по приему экзамена.

    Вы можете ознакомиться с правилами повторной сдачи экзаменов Microsoft, а также с другими процедурами проведения Экзамена и тестирования по адресу [https://www.microsoft.com/learning/certification-exam-policies.aspx](https://www.microsoft.com/learning/certification-exam-policies.aspx). На веб-сайте поставщика услуг по приему Экзамена Экзаменуемые могут больше узнать о его правилах и процедурах.
...
7. **СОБСТВЕННОСТЬ И ВСЕ ПРАВА ЗАЩИЩЕНЫ**
    ...
    7.1. **Собственность**. Microsoft владеет и сохраняет за собой все права, права собственности и права на сертификационный экзамен Microsoft.
...
Вы можете иметь право на получение зачетных единиц колледжа через колледж Excelsior College, аккредитованный на региональном уровне. Национальная служба зачетных единиц колледжей (NCCRS) установила рекомендации по зачетным единицам для следующих сертификационных экзаменов и профессиональных программ Microsoft:

**Сертификационные экзамены Microsoft**

[AZ-100: Инфраструктура Microsoft Azure и развертывание](https://www.microsoft.com/learning/exam-AZ-100.aspx)

[AZ-101: Интеграция Microsoft Azure и безопасность](https://www.microsoft.com/learning/exam-AZ-101.aspx)

[AZ-103: Администратор Microsoft Azure](https://www.microsoft.com/learning/exam-az-103.aspx)

AZ-200: Основные Решения Для Разработчиков Microsoft Azure

AZ-201: Расширенные решения для разработчиков Microsoft Azure

[AZ-203: Разработка решений для Microsoft Azure](https://www.microsoft.com/learning/exam-AZ-203.aspx)

[AZ-300: Технологии Microsoft Azure Architect](https://www.microsoft.com/learning/exam-AZ-300.aspx)

[AZ-301: Дизайн архитектуры Microsoft Azure](https://www.microsoft.com/learning/exam-AZ-301.aspx)

[AZ-400: Решения Microsoft Azure DevOps](https://www.microsoft.com/learning/exam-AZ-400.aspx)

**Профессиональные программы Microsoft**

Профессиональная программа Microsoft: [Сертификат в области искусственного интеллекта](https://academy.microsoft.com/en-us/professional-program/tracks/artificial-intelligence/)

Профессиональная программа Microsoft: [Сертификат в области Big Data](https://academy.microsoft.com/en-us/professional-program/tracks/big-data/)

Профессиональная программа Microsoft: [Сертификат в области Data Science](https://academy.microsoft.com/en-us/professional-program/tracks/data-science/)

Профессиональная программа Microsoft: [Сертификат в области DevOps](https://academy.microsoft.com/en-us/professional-program/tracks/devops/)

Профессиональная программа Microsoft: [Сертификат в разработке программного обеспечения начального уровня](https://academy.microsoft.com/en-us/professional-program/tracks/entry-level-software-development/)

Профессиональная программа Microsoft: [Сертификат специалиста IT-поддержки](https://academy.microsoft.com/en-us/professional-program/tracks/it-support/)

Профессиональная программа Microsoft: [Сертификат в области анализа данных](https://academy.microsoft.com/en-us/professional-program/tracks/data-analysis/)

Профессиональная программа Microsoft: [Сертификат в области IoT](https://academy.microsoft.com/en-us/professional-program/tracks/internet-of-things/)

Профессиональная программа Microsoft: Сертификат в области [Кибербезопасности](https://academy.microsoft.com/en-us/professional-program/tracks/cyber-security/)
...
- Дополнительную информацию см.: [Значки экзаменационной сертификации Microsoft](https://www.microsoft.com/learning/badges.aspx)
...
**Подтверждение свидетельство об окончании курса Профессиональной программы Microsoft:**

- Шаг 2: Войдите в свою учетную запись в [панели управления academy.microsoft.com](https://academy.microsoft.com/en-us/dashboard)

- Шаг 3: Скопируйте и вставьте URL-адрес сертификата курса Профессиональной программы Microsoft, чтобы отправить ссылку на ваш официальный сертификат

- Шаг 4: Вставьте URL-адрес в электронное письмо и отправьте его по адресу [itcertifications@excelsior.edu](mailto:itcertifications@excelsior.edu) вместе с двумя документами, удостоверяющими личность (имя и адрес или имя и дата рождения).

См. MPP [Часто задаваемые вопросы](https://academy.microsoft.com/en-us/professional-program/), если у Вас возникли вопросы насчет MPP.
...
[Каждый вопрос экзамена тщательно рассматривается](https://www.microsoft.com/learning/certification-exams.aspx) группой технических экспертов и специалистов по должностным обязанностям, которые рассматривают каждый вопрос на предмет технической точности, ясности и актуальности. Если вы уверены в недопустимости конкретного вопроса сертификационного экзамена Microsoft, вы можете запросить оценку этого пункта, выполнив описанные ниже действия. Вы должны отправить свое возражение против пункта экзамена в течение 30 дней с момента сдачи экзамена.

**Примечание:** Не используйте процесс оспаривания пунктов экзамена, чтобы направить отзыв о вопросах beta-экзамена. Вопросы beta-экзамена часто изменяются на основании отзывов, полученных в рамках этого процесса, и могут быть удалены из пула вопросов. Отзыв о бета-экзамене, который вы не смогли передать в комментариях, можно отправить по адресу [mslcd@microsoft.com](mailto:mslcd@microsoft.com).

### Порядок оспаривания пунктов экзаменов

1. Отправьте возражение против пункта экзамена на [форум поддержки сертификации Microsoft](https://aka.ms/MCPForum).
2. В течение 1-2 рабочих дней представитель форума предоставит вам **Форму возражения против пунктов экзамена** для заполнения. Форма содержит данные о том, как подать возражение.
   - Возражения против пунктов экзамена принимаются только в том случае, если заполненная форма возражения против пунктов экзамена будет отправлена агенту форума не позднее чем через 30 дней после сдачи экзамена.
   - Возражения по пунктам экзаменов, которые будут отменены в течение 6 месяцев, не принимаются.
3. В течение 4-6 недель агент форума сообщит вам результаты рассмотрения вашего возражения.

Процесс оспаривания реализован, чтобы помогать определять и исправлять проблематичные вопросы. Однако в большинстве случаев экзамены не оцениваются заново, так как корпорация Microsoft должна быть уверена, что кандидаты, которые сдали экзамены и получили наши сертификации, продемонстрировали требуемый уровень специальной подготовки в заданных областях навыков. Даже если вопрос был поставлен в каком-то смысле некорректно, мы не можем предполагать, что вы могли бы ответить правильно на соответствующий корректный вопрос. В таких случаях мы предоставляем кандидатам возможность пересдать экзамен бесплатно.
...
## Специальные условия при приеме экзаменов
...
- Ролевое сертификации Microsoft
- Академические расценки на экзамены
...
| ------------- |:-------------:| -----:|
| Экзамены на должностные роли помощника и эксперта, включающие в себя лабораторные работы      | 150 минут | 180 минут |
...
Сертификационные экзамены Microsoft доступны на различных языках. Кандидаты, которым требуется сдавать экзамен на английском языке, а не на родном, могут запросить дополнительное время. Необходимость предоставления дополнительного времени определяется в индивидуальном порядке. Запросите специальные условия для сдачи экзамена через [Pearson VUE](https://www.pearsonvue.com/accommodations/pv_review.asp?clientName=Microsoft) или [Certiport](https://www.certiport.com/portal/desktopdefault.aspx?page=common/pagelibrary/Disabilities.htm).

**Какие специальные условия доступны для людей с ограниченными возможностями?**

Корпорация Microsoft стремится к тому, чтобы наши экзамены были доступны всем, включая людей с ограниченными возможностями. Список доступных специальных условий можно найти на [Страница со специальными условиями](https://www.pearsonvue.com/accommodations/).
...
Если у вас имеются какие-либо сомнения, касающиеся технической точности конкретного предмета, пожалуйста, ознакомьтесь с процессом [Возражения против пунктов экзамена](https://www.microsoft.com/learning/certification-exam-policies.aspx#policies-5).

Чтобы сообщить о проблеме с центром тестирования или о технических трудностях, возникших во время экзамена, обратитесь в службу поддержки клиентов компании [Pearson VUE](https://www.pearsonvue.com/microsoft/) или [Certiport](https://www.certiport.com/PORTAL/Common/PageLibrary/Support.htm).
...
После того, как вы покинете лабораторную работу, вы не сможете вернуться к ней, потому что оценка начинается (в фоновом режиме), как только вы покидаете лабораторную работу или раздел экзамена. Когда вы нажимаете **Далее**, вам будет предложено подтвердить, что вы действительно хотите покинуть лабораторную работу. Нажатие кнопки **Да** завершит лабораторный раздел, и выполнение задач будет оценено.

**Как структурирован экзамен, когда в нем есть лабораторные работы?**

После запуска экзамена вы будете отвечать на традиционные вопросы (например, множественный выбор, перетаскивание, список построения и т. д.) по мере загрузки лабораторных работ. Когда вы закончите лабораторные работы, вы ответите на другой набор традиционных вопросов по мере того, как лабораторные работы оцениваются. Если вы ответите на первый набор вопросов слишком быстро, вам, возможно, придется дождаться завершения подготовки лабораторных работ. Обратите внимание на следующее:

- После того, как вы покинете любой раздел экзамена, вы не сможете вернуться к нему. Однако у вас есть возможность проверить свои ответы в конце каждого раздела. **Время экзамена НЕ останавливается, когда вы проверяете свои ответы. Убедитесь, что у вас достаточно времени**; следите за временем И количеством оставшихся вопросов.

- В каждым экзамене есть один или два практических раздела/лабораторных работы с несколькими задачами, которые необходимо выполнить. После каждого из них идет серия традиционных элементов, что дает нам время оценить вашу лабораторную работу, и вы можете получить результат "зачет"/"незачет" сразу после окончания экзамена. И еще раз напоминаем - следите за временем. Вам нужно будет ответить на несколько вопросов после лабораторной работы.

- Количество лабораторных работ на экзамене указано на странице описания, предшествующей первой лабораторной работе. Прочтите ее! И распределите время соответственно.

- НЕ ждите исполнения задания перед переходом к следующему. В некоторых (редких) случаях необходимо, чтобы определенное задание было исполнено, прежде чем вы сможете перейти к другому, но при этом должны быть другие задания, над которыми вы можете работать, пока исполняется это задание. **Не теряйте времени, ожидая окончания времени**, отведенного на задание. Переходите к другому заданию, которое не зависит от исполнения текущего, таким образом вы сможете использовать время экзамена с максимальной пользой. В некоторых случаях запуска задания может быть достаточно для оценки (например, создание ресурса в Azure); вы можете разрешить исполнение этого задания в фоновом режиме во время работы над другими заданиями. В список заданий включаются примечания о том, что вам нужно только запустить определенное задание. Вы можете перейти к другим заданиям или даже покинуть раздел (перейти к следующей части экзамена) без штрафов. **Внимательно читайте задания**.
...
По разным причинам мы не можем оценить все критические навыки только с помощью лабораторных работ. Мы не можем просить вас выполнить задачи, выполнение которых занимает более нескольких минут или которые требуют значительных ресурсов; в результате мы будем продолжать оценивать эти навыки, используя типы вопросов, которые больше соответствуют опыту экзамена.
...
Нет. Оцениваемые навыки не зависят от данного формата вопроса. Оцениваемые на экзамене знания и навыки перечислены в разделе «Оценка навыков» на странице сведений об экзамене.
...
Если вам требуется специальное оборудование или другие условия для сдачи экзамена, вы можете запросить их через «Системы запроса специальных условий» на сайте [Pearson VUE](https://www.pearsonvue.com/accommodations/pv_review.asp?clientName=Microsoft) [https://rs.hgportal.net/amer/candidate](https://rs.hgportal.net/amer/candidate). Более подробная информация представлена в разделе Особые условия при сдаче экзаменов выше.

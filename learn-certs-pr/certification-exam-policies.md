...
4. Правила повторной сдачи beta-экзаменов
    1. Beta-экзамены можно сдавать только один раз в течение beta-периода. Если кандидат сдает экзамен (определенный после окончания периода бета-тестирования), он засчитывается для получения кредита для сертификации. Если кандидат не сдает экзамен, его можно пересдать в соответствии с приведенными выше правилами.

...
После заполнения заявки и оплаты отслеживайте получение приглашения MCT, передаваемого по электронной почте. Затем вы можете получить доступ к содержанию MCT на вашей [Панели сертификации](https://www.microsoft.com/learning/dashboard.aspx).
...
- **Убедитесь, что вы соответствуете требованиям программы MCT**, описанным в разделе [Требования](https://www.microsoft.com/learning/mct-certification.aspx#mctinfoheading-3) section of this page. Сверьте свою выписку из зачетной ведомости (транскрипт) со списком текущих сертификатов и квалификаций Microsoft, подходящих для программы MCT.
